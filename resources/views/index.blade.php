					...
					<div class="wrapper">
                        ...
                        @if($products)
                            ...
                            <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                                <h3 class="heading-tittle text-center font-italic">{{$product->name}} </h3>
                                <div class="row">
                                @if(count($product->products) <1)
                                    <h4 class="text-capitalize text-warning text-center">Category Has no products currently!</h4>
                                @else
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											@if($item->image)
                                                <img src="{{asset('uploads/'.$item->image)}}" class="img-thumbnail" alt="Image">
											@else
                                                <img src="{{asset('images/m4.jpg')}}" class="img-thumbnail" alt="See">
                                            @endif
                                            <div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="{{action('ProductController@show',$item->id)}}" class="link-product-add-cart">Quick View</a>
												</div>
											</div>
										</div>
