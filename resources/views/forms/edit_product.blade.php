...
<div class="contact py-sm-5 py-4">
    ...
    @endif
    {{ Form::open(['url'=> '/save_edit/'.$product[0]->id,'files'=>true,'method'=>'PUT']) }}
    ...
    <div class="contact-grids1 w3agile-6">
         ...
         <div class="col-md-6 col-sm-6 contact-form1 form-group">
                ...
                {{ Form::text('title',$product[0]->title,array('class'=>'form-control','required'=>'required')) }}
                </div>

                <div class="col-md-6 col-sm-6 contact-form1 form-group">
                {{ Form::label('quantity', 'Item Quantity:',array('class','col-form-label')) }}
                {{ Form::number('quantity',$product[0]->quantity,['min'=>1,'max'=>5000,'class'=>'form-control','required'=>'required']) }}
                </div>
                <div class="col-md-6 col-sm-6 contact-form1 form-group">
                {{ Form::label('price', 'Item Price(KSH):',array('class','col-form-label')) }}
                {{ Form::number('price',$product[0]->discount_price,['min'=>1,'max'=>100000,'required'=>'required','class'=>'form-control']) }}
                </div>
                <div class="col-md-6 col-sm-6 contact-form1 form-group">
